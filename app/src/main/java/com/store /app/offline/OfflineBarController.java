...
public class OfflineBarController {
    ...
    private static final long COLLAPSE_DURATION = 650L;
    private static final long TEXT_DURATION = 350L;

    private static final Interpolator SPRING_INTERPOLATOR =
    ...
    private void createBadge() {
        ...
        // =====================================================
        // دائرة الأيقونة — ثابتة في اليمين ومتمركزة 100%
        // =====================================================
        ...
        FrameLayout.LayoutParams iconContainerParams =
                new FrameLayout.LayoutParams(
                        dp(24),
                        dp(24)
                );

        iconContainerParams.gravity =
        ...
        auraView.setBackground(
                new AuraDrawable(OFFLINE_COLOR)
        );
        ...
        FrameLayout.LayoutParams auraParams =
                new FrameLayout.LayoutParams(
                        dp(24),
                        dp(24)
                );
        ...
        offlineIcon.setImageDrawable(
                new LuxuryCloudDrawable(
                        OFFLINE_COLOR,
                        true
                )
        );
        ...
        // =====================================================
        // النص
        // النص على الجهة المقابلة للأيقونة
        // =====================================================
        ...
        /*
         * النص يحتل المساحة الموجودة يسار الأيقونة.
         * لا يوجد عرض ثابت للنص.
         */
    ...
    private void installInsetsController() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(
                ...
                (view, insets) -> {
                    ...
                    /*
                     * قراءة منطقة الأمان فقط.
                     * لا توجد WindowInsetsAnimation.
                     * لا توجد ترجمة.
                     * لا توجد حركة مرتبطة باختفاء/ظهور شريط النظام.
                     */
                    navigationBottomInset = navigation.bottom;
    ...
    private void applySafeAreaPosition() {
        ...
        params.rightMargin =
                dp(BADGE_HORIZONTAL_MARGIN_DP);

        /*
         * هذا هامش ثابت فوق منطقة الأمان.
         *
         * لا يوجد translationY.
         * لا يوجد animator.
         * لا يوجد تتبع لحركة Navigation Bar.
         */
        params.bottomMargin =
                navigationBottomInset + dp(BADGE_BOTTOM_MARGIN_DP);
    ...
    private void expandBadge() {
        ...
        int startWidth =
                offlineBadge.getWidth();

        if (startWidth <= 0) {
            startWidth = dp(COLLAPSED_SIZE_DP);
        }
        ...
        /*
         * الهالة تظهر فقط في وضع Offline.
         */
    ...
    private void collapseBadge() {
        ...
        if (startWidth <= 0) {
            startWidth = dp(EXPANDED_WIDTH_DP);
        }
        ...
        activity.runOnUiThread(() -> {
            ...
            if (offlineBadge.getVisibility() != View.VISIBLE) {
                ...
                offlineBadge.animate()
                        ...
                        .setDuration(700L)
                        .setInterpolator(SPRING_INTERPOLATOR)
                        .withEndAction(this::expandBadge)
                        .start();
                ...
                mainHandler.postDelayed(() -> {
                    ...
                    offlineBadge.animate()
                            ...
                            .withEndAction(() -> {
                                ...
                                offlineBadge.setTranslationY(0f);
    ...
    public void shake() {
        ...
        activity.runOnUiThread(() -> {
            ...
            /*
             * فتح تلقائي حتى يظهر التحذير كاملاً.
             */
            if (!expanded) {
                expandBadge();
            }
            ...
            mainHandler.postDelayed(() -> {
                ...
                if (offlineBar != null &&
                        offlineBadge != null &&
                        offlineBadge.getVisibility() == View.VISIBLE) {
    ...
    private static final class LuxuryCloudDrawable extends Drawable {
        ...
        private final boolean showSlash;
        ...
        LuxuryCloudDrawable(
            ...
            this.color = color;
            this.showSlash = showSlash;

            cloudPaint.setStyle(Paint.Style.STROKE);
            cloudPaint.setStrokeWidth(2.15f);
            ...
            slashPaint.setStrokeWidth(2.15f);
            slashPaint.setStrokeCap(Paint.Cap.ROUND);
            slashPaint.setStrokeJoin(Paint.Join.ROUND);
